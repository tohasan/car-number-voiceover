    ...
    describe('#generate', () => {
        ...
        it('should get combinations that contains more long combinations than others ' +
            ...
            expect(voiceovers).toEqual([
                ...
                { name: 'А002ВВ 78', options: ['Александр два ноля двойка две вэ пробел семьдесят восемь'] },
                { name: 'А002ВВ 78', options: ['Анна дубль нуль два дубль вэ регион семьдесят восемь'] }
            ] as Voiceover[]);
        });
    });
});