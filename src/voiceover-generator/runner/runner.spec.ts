    ...
    describe('#run', () => {
        ...
        it('should get voiceovers for the european car numbers', () => {
            ...
            expect(voiceovers).toEqual([
                ...
                'LV NX-1133;эл ви пробел нэ икс дефис две единицы две тройки',
                'LV NX-1133;л вэ н ха дубль один дубль три',
                'LТ EJN:111;Литва и джей эн двоеточие сто одинадцать',
                'LТ EJN:111;латинская эл ти пробел е джи нэ двоеточие три единицы',
                'LТ EJN:111;английская эл тэ латинская е джей н триплет единиц',
                'EST 007 QOJ;Эстония два нуля семь пробел кью оу джи',
                'EST 007 QOJ;английская е эс т пробел два ноля семерка пробел ку о джей',
                'EST 007 QOJ;и сэ ти дубль нуль семь кью оу джи',
                'FIN EGT-018;Финляндия е джи тэ дефис ноль восемнадцать',
                'FIN EGT-018;эф ай латинская эн пробел латинская е гэ т дефис нуль один восемь',
                'FIN EGT-018;фэ и с точкой английская эн английская е латинская гэ ти ноль восемнадцать'
            ].join('\n'));
        });
